/* PrismJS 1.27.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+bash+csv+django+docker+gcode+graphql+hcl+http+ignore+json+json5+jsonp+js-templates+makefile+markdown+markup-templating+nginx+powershell+puppet+python+jsx+tsx+regex+rest+sass+shell-session+sql+typescript+yaml&plugins=autoloader */
